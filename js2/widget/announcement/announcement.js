...
define([
    'lib2/core/Hby',
    'text!widget2/announcement/announcement.html',
    'lib2/vendor/system/data/backbone.localStorage',
    /*'jMarquee',*/
    'lib2/vendor/components/jquery-marquee/jquery-marquee',
    'lib2/vendor/system/data/backbone.localStorage'
], function(Hby, AnnouncementHtm ) {
        
    var AnnouncementView = Hby.View.extend({
