({
    ...
    paths: {
        ...
        uuid: 'lib/vendor/util/Math.uuid',
        jquery: 'lib/vendor/libs/jquery/jquery-2.1.3.min',
        jqueryui: 'lib/vendor/libs/jquery/jquery-ui.min',
        util: 'lib/core/util/Util',
        ucUtil: 'lib/ux/util/Util',
        socket: 'lib/core/data/Socket',
        ...
        plupload_v2: 'lib/vendor/components/plupload/plupload.dev',
        qiniu: 'lib/vendor/libs/qiniu/qiniuSDK',
        toastr: 'lib/vendor/components/toastr/toastr',
        artDialog: "lib/vendor/components/artdialog/src/dialog",
        ztree: "lib/vendor/components/zTree/js/jquery.ztree.all-3.5",
        ...
        qrcode: "lib/vendor/components/qrcode/jquery.qrcode.min",
        zeroClipboard: "lib/vendor/components/zeroClipboard/ZeroClipboard.min",
        slimscroll: 'lib/vendor/components/jquery-slimScroll/jquery.slimscroll.min'
    },
    shim: {
        jquery: {
            exports: '$'
    ...
    modules: [{
        ...
        name: 'widget/selectPersonnel/app',
        exclude: [
            'jquery',
            'jqueryui',
            'underscore',
